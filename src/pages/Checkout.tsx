        ...
        <div className="lg:col-span-7 flex flex-col gap-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" placeholder="Họ và tên" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow" />
              <input type="tel" placeholder="Số điện thoại" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow" />
              <input type="email" placeholder="Email" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow md:col-span-2" />
              
              <div className="md:col-span-2">
                <input type="text" placeholder="Tỉnh/Thành phố, Quận/Huyện, Phường/Xã" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow mb-4" />
                <input type="text" placeholder="Số nhà, tên đường" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow" />
              </div>
              ...
              <textarea placeholder="Ghi chú đơn hàng (không bắt buộc)" className="w-full bg-[#F3F2F0] rounded-xl py-3.5 px-4 text-xs outline-none focus:ring-1 ring-black/20 transition-shadow md:col-span-2 h-20 resize-none mt-2"></textarea>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-3">
              ...
              <label className="flex items-center gap-4 p-4 border border-black/10 rounded-2xl cursor-pointer hover:border-black transition-colors bg-white">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-black/60 mt-1">Chuyển khoản qua ứng dụng Mobile Banking.</p>
                </div>
              </label>
              ...
              <label className="flex items-center gap-4 p-4 border border-black/10 rounded-2xl cursor-pointer hover:border-black transition-colors bg-white">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold">Ví điện tử Momo / ZaloPay</p>
                  <p className="text-[10px] text-black/60 mt-1">Thanh toán an toàn qua ví điện tử.</p>
                </div>
              </label>
            </div>
          </section>
